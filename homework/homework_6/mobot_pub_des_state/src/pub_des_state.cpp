...
void DesStatePublisher::initializeSubscribers() {
    alarm_subscriber_ = nh_.subscribe("lidar_alarm", 1, &DesStatePublisher::alarmCB, this); // Modified by Jonathan
    dist_subscriber_ = nh_.subscribe("lidar_dist", 1, &DesStatePublisher::alarmCB, this); // Modified by Jonathan
}
